...
namespace NetMQ
{
    ...
    public struct Msg
    {
        ...
        /// </summary>
        public bool IsDelimiter { get { return MsgType == MsgType.Delimiter; } }
        ...
        public bool IsInitialised { get { return MsgType != MsgType.Uninitialised; } }
        ...
        /// </summary>
        public bool HasMore { get { return (Flags & MsgFlags.More) == MsgFlags.More; } }
        ...
        /// </summary>
        public bool IsShared { get { return (Flags & MsgFlags.Shared) != 0; } }

        /// <summary>
        /// Get whether the Identity bit is set on the Flags property.
        /// </summary>
        public bool IsIdentity { get { return (Flags & MsgFlags.Identity) != 0; } }
